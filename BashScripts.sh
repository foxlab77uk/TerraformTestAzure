...
STORAGE_ACCOUNT_NAME=foxlabtstateaz
...
az keyvault create --name "foxlabkv" --resource-group $RESOURCE_GROUP_NAME --location uksouth
az keyvault secret set --vault-name "foxlabkv" --name "tstateaccess" --value {$ACCOUNT_KEY}
az keyvault secret show --vault-name "foxlabkv" --name "tstateaccess"
